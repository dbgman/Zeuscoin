...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 1251904;
...
/* Premine amount */
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(7500000000000000);
...
*/
const char     GENESIS_COINBASE_TX_HEX[]                     = "010a01ff0001edd9a1daaaa003029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd0880712101dfd97235e20ad3c4787ffa80dd29eb09f0b1cbb9fe9e360d800c4afd99cb41a3";
...
const uint64_t MINIMUM_MIXIN_V1                              = 5;
...
const char     CRYPTONOTE_BLOCKS_FILENAME[]                  = "Zeusblocks.bin";
const char     CRYPTONOTE_BLOCKINDEXES_FILENAME[]            = "Zeusblockindexes.bin";
const char     CRYPTONOTE_POOLDATA_FILENAME[]                = "Zeuspoolstate.bin";
const char     P2P_NET_DATA_FILENAME[]                       = "Zeusp2pstate.bin";
const char     MINER_CONFIG_FILE_NAME[]                      = "miner_conf.json";
} // parameters

const char     CRYPTONOTE_NAME[]                             = "ZeusCoin";
...
const int      P2P_DEFAULT_PORT                              =  35948;
const int      RPC_DEFAULT_PORT                              =  35949;

const size_t   P2P_LOCAL_WHITE_PEERLIST_LIMIT                =  1000;
const size_t   P2P_LOCAL_GRAY_PEERLIST_LIMIT                 =  5000;

const size_t   P2P_CONNECTION_MAX_WRITE_BUFFER_SIZE          = 32 * 1024 * 1024; // 64 MB
...
{
    {  0x5a, 0x45, 0x55, 0x53, 0x4b, 0x49, 0x4e, 0x47, 0x4f, 0x46, 0x47, 0x4f, 0x44, 0x53, 0x21, 0x0a  }
};

const char* const SEED_NODES[] = {
  "45.32.188.226:35948", //Zeus
  "45.32.188.226:35948", //Zeus
